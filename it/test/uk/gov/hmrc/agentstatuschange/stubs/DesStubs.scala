...
trait DesStubs {
  ...
  def givenBusinessPartnerRecordExistsFor(idType: String,
                                          utr: Utr,
                                          arn: Arn,
                                          agencyName: String): StubMapping =
    stubFor(
  ...
  def givenBusinessPartnerRecordNotFoundFor(idType: String,
                                            utr: Utr,
                                            arn: Arn,
                                            agencyName: String): StubMapping =
    stubFor(
  ...
  def givenBusinessPartnerRecordInvalidFor(idType: String,
                                           utr: Utr,
                                           arn: Arn,
                                           agencyName: String): StubMapping =
    stubFor(
